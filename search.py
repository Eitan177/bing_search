...
class similar:
    ...
    def showalbum(self,key):
        ...
        components.html("""<a href="https://twitter.com/intent/tweet?button_hashtag=TwitterDev&ref_src=twsrc%5Etfw" class="twitter-hashtag-button" data-show-count="false">Tweet #TwitterDev</a><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>""")       
        return self
