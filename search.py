...
class similar:
    ...
    def showalbum(self,key):
        ...
        components.html("""<a class="twitter-timeline" data-width="1100" data-height="800" href="https://twitter.com/JHUPath?ref_src=twsrc%5Etfw">Tweets by JHUPath</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>""",
